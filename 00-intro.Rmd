...
```{definition, label="perspectiva-cientifica", name="Música como ciencia"}
Aquí vai un exemplo sen numerar...
```
...
```{r figura-musas-1, echo=FALSE, fig.align='center', fig.pos='h',  fig.cap="Representación de Zeus e as nove musas fillas de Zeus. - (wikimedia)", fig.scap="Apolo e as nove musas inspiradoras das artes e as ciencias", out.width="100%"}
