...
## A música como mensaxe dentro do contexto socio-cultural da historia {-}
<!--%%%%%%%%% DEFINICIÓN E ORIXES DA MÚSICA: %%%%%%%%%%-->

### Orixe e definición de música {-}

A pregunta máis difícil que se pode facer a un músico, compositor, intérprete,(...) é o significado de «música».  
...
Unha primeira aproximación ao concepto de «música», lévanos a procurar o seu significado etimolóxico. Sabemos que provén de *mousiké* palabra grega asociada a *mousa* (musa) e fai referencia, na mitoloxía grega, ás nove fillas de Zeus, encargadas de "deleitar" aos Deuses do Olimpo. Eran igualmente, as encargadas da inspiración artística e científica humana, das cales Euterpe, era a relacionada coa música.


```{r fig:musas-1, fig.align='center', fig.cap="As nove musas fillas de Zeus, co deus Apolo. (Fonte: wikimedia - mitoloxía grega).", out.width="50%"}
