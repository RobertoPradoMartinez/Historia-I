...
As definicións sobre este concepto son moitas e variadas. Probablemente, malia que nos resulte familiar e vivamos rodeados dela, resultaría complicado atopar unha única definición. Non será ata os anos noventa do século pasado, cando se realicen as primeiras definicións concretas (e complexas) sobre música. Ao longo da historia, a música recibe diferentes tratamentos e acepcións. Constitúe unha das manifestacións do espíritu creador do ser humano e está relacionada con aspectos sociais e culturais ao longo da historia:
...
Na mitoloxía grega, fai referencia a calquera arte presidida polas musas[^def:mousike]. Como veremos, nos períodos heleno e helenístico, a música terá un papel central na sociedade civil e relixiosa, promovendo o entretemento e formando parte de razoamentos científico-filosóficos: Platón (s.V-VI a.C) concibía a música como "*o arte educativo por excelencia que se insire na alma e forma a ésta, na virtude*". 

<!--- TODO: Meter como pensamentos musicais no final
- Boecio (s.VI) consideraba a música como a "habilidade de examinar [...] a diversidade de sons [...] por medio da razón e os sentidos". 
- Santo Tomás (s.XIII) consideraba a música como "a máis noble das ciencias humanas [...] que ocupa o primeiro lugar entre as artes liberais". 
- Rouseaus (s.XVIII) definía a música como "o arte de combinar sons de xeito agradable ó oído". 
- Pau Casals (s.XIX-XX), mantiña que "a música, esa marabillosa linguaxe universal, debería ser unha fonte de comunicación". 
-->

Entre as diversas perspectivas que tentan explicar que é a música, vexamos as seguintes definicións:  
...
```{r figura-musas-1, echo=FALSE, fig.align='center', fig.pos='h',  fig.cap="Representación de Zeus e as nove musas fillas de Zeus. - (wikimedia)", fig.scap="Representación das nove musas co deus Apolo", out.width="100%"}
