...
positioning,shadows,shadings,backgrounds,calc,shapes,tikzmark, chains}%
...
\usepackage[b]{esvect}
\usepackage{rotating}
%\usepackage{float} % control de gráficos ==> da erro
\usepackage{floatrow}
...
\usepackage{schemata} % entornos gráficos con chaves
\usepackage{smartdiagram} % diagramas con Tikz
%\usepackage{wrapfig} % imaxes á beira --> DA ERRO
%\usepackage[rflt]{floatflt} % texto rodeando imaxes --> DA ERRO
%
%   ---------   Notas á marxe       ----------
%   
\renewcommand{\sidenote}[1]{% \sidenote{<side note>}
  \mbox{\textsuperscript{\roman{sidenote}}}%
  \marginpar{
  \footnotesize
%  \raggedright % alineación izquierda
  \strut
  \mbox{
  \textsuperscript{\roman{sidenote}}}
  \refstepcounter{sidenote}  
  #1}%
}
\setlength{\marginparwidth}{1.0in} % ancho da nota
...
%   \begin{ejemplo}[][ref]
%
%   TEXTO: con recadro gris   
%   \begin{texto}
%   \begin{texto}[de tal]
%
%   TEXTO: lectura de fontes   
%   \begin{texto}
%   \begin{texto}[de tal]
%
%   
...
%   ----------------
%   Para usar este entorno:
%   \begin{lembra}  o \begin{lembra}[o título] o \begin{lembra}[o título][ref]
\newcounter{tcblembra}[chapter] % con numeración
\renewcommand{\thetcblembra}{}
%\renewcommand{\thetcblembra}{\thechapter.\arabic{tcblembra}}
\colorlet{colorfondoejemplo}{gray!5}
%\definecolor{colorejemplo}{rgb}{.0,.0,.3} % definido en ejemplo
% Ejercicio
\newtcolorbox{wwlembra}[3][]{%
arc=0mm,
breakable,drop fuzzy shadow,
enhanced,
colback=grisamarillo,
...
enlarge top at break by=0mm,pad at break=2mm,
fontupper=\normalsize,
step and label={tcblembra}{#3},
overlay unbroken={%barra vertical
\draw[color=verdep,line width=3pt] ([xshift=2pt] frame.north west)--([xshift=2pt] frame.south west);                            
% Caja de imagen Ejercicio
\node[rectangle, 
         text=black, 
         inner sep=1mm,anchor=west,font=\small\sffamily] at ([xshift=-14.3pt,yshift=-4.1mm]frame.north west)%
{\includegraphics{images/nodolembra}\raisebox{0.5cm}{}};
% Caja numeración y descripción
\node[rectangle, 
 text=black, 
 inner sep=1mm,
...
#1}
%-
\NewDocumentEnvironment{lembra}{O{} O{} O{}}{\smallskip\begin{wwlembra}{#1}{#2}%
 #3}{\end{wwlembra}\smallskip }
%
%   fin entorno: LEMBRA
%
...
% on the top border
\newenvironment{parche}[1][Example]{%
