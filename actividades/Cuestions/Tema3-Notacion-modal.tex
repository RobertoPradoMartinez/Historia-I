...
% ------------------------------------
\newproblem{T3NOTA-01}{
As notacións máis antigas utilizaban uns signos chamados neumas, que se escribían sobre as liñas do propio texto que se debía cantar. Alá polo século XI, Guido d’Arezzo crea varias técnicas que facilitaban a lectura a primeira vista e por tanto a aprendizaxe dos cantos, entre elas \ldots
    \begin{enumerate}[a)]
    \item 
