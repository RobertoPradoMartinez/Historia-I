...
%% MOI IMPORTANTE:
%% ---------------
%% Esta versión do modelo de probas, utiliza exercicios aleatorios.
%% É importante non volver compilar despois de obter a versión definitiva.
%% Revisar sempre a que as solucións coincidan coas cuestións da proba.
%%
