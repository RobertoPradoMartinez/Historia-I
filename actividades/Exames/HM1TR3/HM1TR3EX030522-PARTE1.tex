...
\begin{document}
%\hideanswers    % sen respostas
\showanswers    % con respostas
%
% Portada:
% --------
...
\begin{multicols}{2}
	\begin{enumerate}[1.-]
    \foreachproblem[Tema4-ARS-NOVA]{\item\label{prob:\thisproblemlabel}\thisproblem} % Grecia
    \foreachproblem[Tema5-RENA-PER]{\item\label{prob:\thisproblemlabel}\thisproblem} % Pensamento
    \foreachproblem[Tema5-RENA-TEC]{\item\label{prob:\thisproblemlabel}\thisproblem} % Organoloxía
    \foreachproblem[Tema5-RENA-FLANDES]{\item\label{prob:\thisproblemlabel}\thisproblem} % Roma
    \foreachproblem[Tema5-RENA-ROMA]{\item\label{prob:\thisproblemlabel}\thisproblem}
    \foreachproblem[Tema5-RENA-ES]{\item\label{prob:\thisproblemlabel}\thisproblem} % Periodización
    \foreachproblem[Tema5-RENA-ENG]{\item\label{prob:\thisproblemlabel}\thisproblem} %
    \foreachproblem[Tema5-RENA-FRA]{\item\label{prob:\thisproblemlabel}\thisproblem} %
    \foreachproblem[Tema5-RENA-DE]{\item\label{prob:\thisproblemlabel}\thisproblem}%     
    \foreachproblem[Tema4-IM-AU]{\item\label{prob:\thisproblemlabel}\thisproblem}
    \end{enumerate}
\end{multicols}
%
\end{document}
