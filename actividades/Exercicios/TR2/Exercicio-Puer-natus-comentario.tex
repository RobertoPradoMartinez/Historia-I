...
%
% COMENTARIO DE AUDICIÓN CON CONTEXTUALIZACIÓN
% --------------------------------------------
%
% Partitura de Puer natus est nobis:
% ----------------------------------
\begin{figure}[h!]
\vspace*{2.0cm}
\centering
\begin{subfigure}[b]{0.45\textwidth}
\includegraphics[width=\linewidth]{audicions/Puer-natus.eps}
\caption{Transcrición en notación cadrada}
\label{fig:Puer-natus1}
\end{subfigure}
\begin{subfigure}[b]{0.45\textwidth}
\includegraphics[width=\linewidth]{ud-03/puer-natus-est-analisis.png}
...
\vspace*{1.50cm}
\begin{subfigure}[b]{0.45\textwidth}
\includegraphics[width=\linewidth]{ud-03/Puer-natus-big.png}
\caption{Notación con melismas e neumas}
\label{fig:Puer-natus2}
\end{subfigure}
\begin{subfigure}[b]{0.50\textwidth}
\includegraphics[width=\linewidth]{ud-03/Analisis-puer-natus-p2.png}
\caption{Notación con melismas e neumas}
...
%    \centering
%    \includegraphics[width=\textwidth]{audicions/Puer-natus.eps}
%    \caption{Grafía e texto da obra «Puer natus est»}
%    \label{fig:Puer-natus}
%\end{minipage}
%\end{figure}
%
\vspace*{0.25cm}
\begin{ejercicio}[Comenta e contextualiza «Puer natus est»]
