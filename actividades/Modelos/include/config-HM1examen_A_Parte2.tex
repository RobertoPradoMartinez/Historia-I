...
%
\newtcolorbox{instruccions}[1]{colback=gray!2!white,
colframe=gray!50!cornflowerblue,fonttitle=\bfseries, 
title=\centering{INSTRUCCIÓNS PARA REALIZAR A PROBA}
\vspace*{0.10cm}}
% Cuadro numerado para ejemplos
\newtcolorbox[auto counter,number within=section]{example}[2][]
{colback=green!5!white,colframe=green!75!black,fonttitle=\bfseries, 
title=Exemplo~\thetcbcounter: #2,#1}
