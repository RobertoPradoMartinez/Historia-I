...
\addcontentsline{toc}{section}{Música: concepto e significado}
...
\label{exm:foo} \iffalse (Entornos de bookdown) \fi{} Esto es un ejemplo.
\end{example}

\begin{exercise}[Exercicio sobre o tema 1]
\label{exr:exercicio1} \iffalse (Exercicio sobre o tema 1) \fi{} Esto es un ejemplo.
\end{exercise}
