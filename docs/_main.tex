...
\documentclass[spanish, activeacute, a4paper, nobind]{templates/ociamthesis}
...
%\usepackage{garamond} % fuente de texto
...
%%%%%%% RENOMBRAR TÍTULOS DE CAPÍTULOS %%%%%%%%%
...
%\renewcommand{\abstractname}{Presentación}
%\renewcommand{\appendixname}{Apéndice}
%\renewcommand{\bibname}{Biblografía}
...
\begin{mclistof}{Glosario e abreviaturas}{3.2cm}
