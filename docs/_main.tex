...
\hypertarget{a-mensaxe-musical.-a-muxfasica-como-linguaxe-universal}{%
\subsection*{A mensaxe musical. A música como linguaxe universal}\label{a-mensaxe-musical.-a-muxfasica-como-linguaxe-universal}}
\addcontentsline{toc}{subsection}{A mensaxe musical. A música como linguaxe universal}
...
\begin{quote}
No sólo cumple una función estrictamente educativa cuando hablamos de aprendizajes musicales, sino que también cumple otros fines. Nos propicia a descubrir nuestro propio mundo interior, la comunicación con ``el otro'' o ``los otros'' y la captación y apreciación del mundo que nos rodea.\footnote{a profesora Josefa Moreno \ldots{}}
\end{quote}
