...
\setlength{\textbaselineskip}{12pt plus1pt}
...
\begin{acknowledgements}
 	Este proxecto sae adiante partindo do esforzo de anos de incansable traballo pola miÃ±a parte e dende logo, non serÃ­a posible sen a axuda de toda aquela xente que durante este tempo se mantÃ©n ao meu carÃ³n, apoiando a miÃ±a labor docente no Conservatorio Profesional de MÃºsica de Viveiro (Lugo).

  Debo agradecer a John Gruber por ofrecer e compartir de xeito desinteresado o \texttt{Markdown}; a John MacFarlane por crear o \texttt{Pandoc} (\url{http://pandoc.org}) indispensable na conversiÃ³n de Markdown a outros formatos; a Yihui Xie por crear \texttt{knitr} e \texttt{bookdown} sen os cales todo este traballo non serÃ­a posible de realizar.

  Un agradecemento especial a Ulrik Lyngs por crear e desenvolver o modelo \texttt{oxfordown} que sirve de base na elaboraciÃ³n, maquetaciÃ³n e deseÃ±o deste traballo, sen o cal serÃ­a impensable dada a sÃºa magnitude, e como non a J.J Allaire, fundador e CEO de \href{http://rstudio.com}{RStudio} software empregado para a elaboraciÃ³n deste proxecto.
...
\textgreater{} \emph{La \textbf{Historia de la música} es el estudio de las diferentes tradiciones en la música y su orden en el planeta}.
\textgreater{}
\textgreater{} \[...\] \emph{aquella disciplina que trata el estudio de la evolución de las diferentes tradiciones musicales a lo largo del tiempo}.

Se consultamos a \href{https://dle.rae.es/}{Real Academia Española da lingua} (RAE) veremos que define \href{https://dle.rae.es/historia\#otras}{«historia»} como:
...
Se facemos esta consulta no diccionario da \href{https://academia.gal/dicionario}{Real Adacemia Galega da lingua} (RAG), atopamos a seguinte definición de \href{https://academia.gal/dicionario/-/termo/busca/Historia}{«historia»}:
...
Se consultamos a definición de \href{https://digalego.xunta.gal/es/termo/44501/m\%C3\%BAsica}{«música»}:
\textgreater{} Arte de combinar harmoniosamente os sons, segundo unhas regras preestablecidas.

Segundo a definición tradicional, «música»: \footnote{Os gregos definen a música como «a arte das musas»}
...
\textbf{Historia da música} \emph{\textbf{occidental}}, céntrase
principalmente no estudo da evolución das diferentes manifestacións
musicais \(tradición musical\) das culturas de occidente (neste caso as
culturas e sociedades musicais europeas) ao longo do tempo.
\end{correction}
...
\begin{longtable}[]{@{}ll@{}}
\toprule
ACTIVIDADE & TERMINO MUSICAL \\ \addlinespace
\midrule
\endhead
Produción & Composición \\ \addlinespace
Difusión & Interpretación \\ \addlinespace
Consumo & Audición \\ \addlinespace
\bottomrule
\end{longtable}
...
\hypertarget{as-fontes-como-ferramenta-para-narrar-a-historia-da-muxfasica}{%
\subsection*{As fontes como ferramenta para narrar a Historia da Música}\label{as-fontes-como-ferramenta-para-narrar-a-historia-da-muxfasica}}
\addcontentsline{toc}{subsection}{As fontes como ferramenta para narrar a Historia da Música}

\hypertarget{tipos-de-fontes}{%
\subsection*{Tipos de fontes}\label{tipos-de-fontes}}
\addcontentsline{toc}{subsection}{Tipos de fontes}
...
\hypertarget{as-fontes-como-ferramenta-para-narrar-a-historia-da-muxfasica-1}{%
\subsection*{As fontes como ferramenta para narrar a Historia da Música}\label{as-fontes-como-ferramenta-para-narrar-a-historia-da-muxfasica-1}}
\addcontentsline{toc}{subsection}{As fontes como ferramenta para narrar a Historia da Música}

\hypertarget{tipos-de-fontes-1}{%
\subsection*{Tipos de fontes}\label{tipos-de-fontes-1}}
\addcontentsline{toc}{subsection}{Tipos de fontes}
...
\hypertarget{as-fontes-como-ferramenta-para-narrar-a-historia-da-muxfasica-2}{%
\subsection*{As fontes como ferramenta para narrar a Historia da Música}\label{as-fontes-como-ferramenta-para-narrar-a-historia-da-muxfasica-2}}
\addcontentsline{toc}{subsection}{As fontes como ferramenta para narrar a Historia da Música}

\hypertarget{tipos-de-fontes-2}{%
\subsection*{Tipos de fontes}\label{tipos-de-fontes-2}}
\addcontentsline{toc}{subsection}{Tipos de fontes}
