...
\hypertarget{introduciuxf3n-e-conceptos-previos}{%
\chapter*{Introdución e conceptos previos}\label{introduciuxf3n-e-conceptos-previos}}
\addcontentsline{toc}{chapter}{Introdución e conceptos previos}
...
\hypertarget{orixe-e-definiciuxf3n-de-muxfasica}{%
\section*{Orixe e definición de música}\label{orixe-e-definiciuxf3n-de-muxfasica}}
\addcontentsline{toc}{section}{Orixe e definición de música}

As definicións sobre o concepto de «música» son moitas e variadas. Ao longo da historia, recibe diferentes tratamentos e acepcións e constitúe unha das manifestacións do espíritu creador do ser humano, relacionándose directamente con aspectos sociais e culturais.
...
Na mitoloxía grega, a «música» fai referencia a calquera arte presidida polas musas\footnote{O término «música» {[}\ldots{]} deriva do grego \emph{mousike} (\emph{techne}) (arte das musas), feminino de \emph{mousikos} «pertencente ás musas», de \emph{Mousa} «Musa».}: nos períodos heleno e helenístico, a música ten un papel central na sociedade civil e relixiosa, promovendo o entretemento e formando parte de razoamentos científico-filosóficos. Platón (s.\textsc{v-vi} a.c.) concibía a música como a arte educativa por excelencia que se insire na alma e forma a ésta, na virtude. Boecio (s.VI) consideraba a música como a ``habilidade de examinar {[}\ldots{]} a diversidade de sons {[}\ldots{]} por medio da razón e os sentidos''. Santo Tomás (s.XIII) consideraba a música como ``a máis noble das ciencias humanas {[}\ldots{]} que ocupa o primeiro lugar entre as artes liberais''. Rousseau, (s.XVIII) definía a música como ``o arte de combinar sons de xeito agradable ó oído''. Pau Casals (s.XIX-XX), mantiña que ``a música, esa marabillosa linguaxe universal, debería ser unha fonte de comunicación''.
...
\begin{quote}
{[}\ldots{]} as definicións e conceptos sobre música eran difusos e dependían, en grande medida, da época, o lugar e sobre todo, dos diferentes puntos de vista. Durante a Idade Media os trobadores e músicos ambulantes non eran considerados músicos coma hoxe en día, senón filósofos, capaces de manexar os conceptos teóricos de harmonía. {[}\ldots{]} Non obstante, existen outras moitas perspectivas para intentar explicar o que é a música\footnote{López Cobas, L.: \emph{Historia da Música}, Conservatorio Profesional de Música de Ourense, (Setembro, 2021)}.
\end{quote}

\hypertarget{que-uxe9-a-muxfasica}{%
\subsection*{Que é a música?}\label{que-uxe9-a-muxfasica}}
\addcontentsline{toc}{subsection}{Que é a música?}

Existen diferentes perspectivas que tentan explicar o significado da «música». Entre as máis destacadas, atopamos as seguintes.

\begin{definition}[Música como ciencia]
\label{def:perspectiva-cientifica} \iffalse (Música como ciencia) \fi{} Aquí vai un exemplo sen numerar\ldots{}
\end{definition}

Este é un exemplo, como podes ver en \ref{def:perspectiva-cientifica}

\begin{description}
\tightlist
\item[Música como ciencia.]
Pitágoras, filósofo grego, afirmaba alá polo s.V a.C, que:
...
Richard Wagner, compositor alemán do s. XIX, consideraba que
...
\item
  dos sentimentos dunha persoa: por exemplo a sonata \emph{Claro de Luna} de L.v. Beethoven, \emph{Lamento de Adriana} de C. Monteverdi
\item
  o sentir dun pobo: caso dun himno nacional
\end{itemize}

\hypertarget{creaciuxf3n-artuxedstica-musical}{%
\subsection*{Creación artística-musical}\label{creaciuxf3n-artuxedstica-musical}}
\addcontentsline{toc}{subsection}{Creación artística-musical}

A música é unha \textbf{arte abstracta} que posúe un grao de abstracción superior a calquera outra, e polo tanto, é unha \textbf{arte espiritual}, \textbf{humana} e \textbf{universal}. Precisa, certos coñecementos específicos para chegar a comprender plenamente a realidade científica que lle da forma; é unha \textbf{arte dinámica}, que transcorre no tempo (temporalidade); o oínte, necesita ir interiorizando a obra\footnote{Para que a música exista, debe desenvolverse no tempo e, permitir así que o oínte a poida apreciar. A ``memoria auditiva'' xoga aquí un papel importante, pois o oínte non poderá apreciar ben a música, se non retén na memoria algúns dos seus compoñentes como poden ser, a melodía, o ritmo ou timbre.} a medida que a escoita, para así poder captala\footnote{As artes estáticas como a pintura, precisan dun lugar determinado, un espazo, que permite ao espectador contemplalas o tempo que queira e captalas dun golpe coa mirada. Segundo a clasificación tradicional das belas artes, son artes estáticas ou do espazo: a pintura, a escultura e arquitectura por exemplo. Como artes dinámicas, consideramos: a poesía, danza, música e o cine por exemplo.} íntegramente; por iso, é unha \textbf{arte viva} capaz de facer presente calquera tempo histórico\footnote{A música renace con cada interpretación, e está constantemente nun proceso de reactivación. O resultado, depende tanto dos intérpretes coma do público e por iso, podemos definir a música de dous xeitos: coma obxecto autónomo (produto) e coma proceso (actividade).}.
...
\hypertarget{o-proceso-creador-e-a-inspiraciuxf3n}{%
\subsubsection*{O proceso creador e a inspiración}\label{o-proceso-creador-e-a-inspiraciuxf3n}}
\addcontentsline{toc}{subsubsection}{O proceso creador e a inspiración}

\hypertarget{transmisiuxf3n-da-mensaxe-musical}{%
\subsection*{Transmisión da mensaxe musical}\label{transmisiuxf3n-da-mensaxe-musical}}
\addcontentsline{toc}{subsection}{Transmisión da mensaxe musical}
...
\hypertarget{audiciuxf3n-e-ouxednte.-como-escoitar}{%
\subsection*{Audición e oínte. Como escoitar?}\label{audiciuxf3n-e-ouxednte.-como-escoitar}}
\addcontentsline{toc}{subsection}{Audición e oínte. Como escoitar?}

\hypertarget{aprendo-a-escoitar-muxfasica}{%
\subsubsection*{Aprendo a escoitar música}\label{aprendo-a-escoitar-muxfasica}}
\addcontentsline{toc}{subsubsection}{Aprendo a escoitar música}

\hypertarget{a-sensibilidade-musical}{%
\subsubsection*{A sensibilidade musical}\label{a-sensibilidade-musical}}
\addcontentsline{toc}{subsubsection}{A sensibilidade musical}

\hypertarget{apreciar-e-comprender-a-muxfasica}{%
\subsubsection*{Apreciar e comprender a música}\label{apreciar-e-comprender-a-muxfasica}}
\addcontentsline{toc}{subsubsection}{Apreciar e comprender a música}

\hypertarget{couxf1ecer-axuda-a-comprender}{%
\subsubsection*{Coñecer axuda a comprender}\label{couxf1ecer-axuda-a-comprender}}
\addcontentsline{toc}{subsubsection}{Coñecer axuda a comprender}

\hypertarget{a-obra-de-arte-musical}{%
\section*{A obra de arte musical}\label{a-obra-de-arte-musical}}
\addcontentsline{toc}{section}{A obra de arte musical}

\hypertarget{concepto-de-muxfasica}{%
\section*{Concepto de música}\label{concepto-de-muxfasica}}
\addcontentsline{toc}{section}{Concepto de música}
...
\hypertarget{algunhas-definiciuxf3ns-aceptadas}{%
\subsection*{Algunhas definicións aceptadas}\label{algunhas-definiciuxf3ns-aceptadas}}
\addcontentsline{toc}{subsection}{Algunhas definicións aceptadas}
...
\caption{Insertar imaxes en RStudio.}\label{fig:figura-exemplo1}
\end{figure}
