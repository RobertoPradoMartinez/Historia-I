...
As definicións sobre este concepto son moitas e variadas. Probablemente, malia que nos resulte familiar e vivamos rodeados dela, resultaría complicado atopar unha única definición. Ao longo da historia, a música recibe diferentes tratamentos e acepcións. Constitúe unha das manifestacións do espíritu creador do ser humano e está moi relacionada con aspectos sociais e culturais.
...
{\centering \includegraphics[width=1\linewidth]{figures/ud-00/musas-2} 

}

\caption[Representación das nove musas inspiradoras e Atenea]{Representación de Atenea e as nove musas fillas de Zeus. - (wikimedia)}\label{fig:figura-musas-2}
\end{figure}

Etimolóxicamente a palabra «música», provén de \emph{mousiké} palabra grega asociada a \emph{mousa} (musa) e fai referencia, na mitoloxía grega, ás nove fillas de Zeus, encargadas de ``deleitar'' aos Deuses do Olimpo. Eran igualmente, as encargadas da inspiración artística e científica humana, das cales Euterpe, era a relacionada coa música.
...
\caption[Representación das nove musas co deus Apolo]{Representación de Zeus e as nove musas fillas de Zeus. - (wikimedia)}\label{fig:figura-musas-1}
\end{figure}
